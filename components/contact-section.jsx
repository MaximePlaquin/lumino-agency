    ...
    <section id="contact" className="py-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-20">
          <motion.p className="text-sm uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-3" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            Contact
          </motion.p>
          ...
          <motion.p className="text-xl text-gray-500 dark:text-gray-400 max-w-3xl mx-auto" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
        ...
        {state.succeeded ? (
          <div className="text-center py-20">
            ...
            <p className="text-muted-foreground">
              {contactInfo.form.successMessage || "Merci pour votre message ! Nous vous répondrons très vite."}
            </p>
          </div>
        ) : (
          <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
            ...
            <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-lg">
